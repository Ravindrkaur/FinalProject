 ...
 */
public class MyInformation1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_information2);
        ...
        String mid = (sharedPreferences.getString(MyPref.UserIdentityKey, null));
